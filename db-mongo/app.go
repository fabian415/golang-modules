...
// GetUser 根據 ID 獲取用戶
func (a *App) GetUser(id string) (map[string]interface{}, error) {
	db := GetDBInstance()
...
// UpdateUser 更新用戶
func (a *App) UpdateUser(id string, name, email string, age int) (string, error) {
	db := GetDBInstance()
...
// DeleteUser 刪除用戶
func (a *App) DeleteUser(id string) (string, error) {
	db := GetDBInstance()
